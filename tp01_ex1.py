...
if unit_uti == "J":
    ...
    print("""Valeur en entrée : {} {}
        ---------Conversion---------
        en ft-lb : {} ft-lb
        en calories : {} cal
        en eV : {} eV""".format(magnitude_uti, unit_uti, conversion_ft_lb, conversion_cal, conversion_ev))
    ...
    print("""Valeur en entrée : {} {}
        ...
        en ft-lb : {} J
        en calories : {} cal
        en eV : {} eV""".format(magnitude_uti, unit_uti, conversion_j, conversion_cal, conversion_ev))
    # Affichage des données converties
elif unit_uti == "cal":
    ...
    print("""Valeur en entrée : {} {}
        ...
        en ft-lb : {} ft-lb
        en calories : {} J
        en eV : {} eV""".format(magnitude_uti, unit_uti, conversion_ft_lb, conversion_j, conversion_ev))
    # Affichage des données converties
else:
    ...
    print("""Valeur en entrée : {} {}
        ...
        en ft-lb : {} ft-lb
        en calories : {} cal
        en eV : {} J""".format(magnitude_uti, unit_uti, conversion_ft_lb, conversion_cal, conversion_j))
    # Affichage des données converties
